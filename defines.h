...
*/
// g++ -I/home/naveen/source/include -o defines.o defines.h
...
#define NAME_L_REVISION ".L30N0.01" 
#endif
#define NAME_VERSION "1.0.48.03" NAME_L_REVISION
#define NAME_PV NAME_P " v" NAME_VERSION

// todo: use tcltk or pytk or straight x11 widgets
...
// Don't increase LINE_SIZE above 65535 without considering ArgStruct::length's type (WORD).
...
#define SYM_DYNAMIC_IS_DOUBLE_DEREF(token) (token.buf) 
// SYM_DYNAMICs other than doubles have NULL buf, at least at the stage this macro is called.

#define SYM_DYNAMIC_IS_VAR_NORMAL_OR_CLIP(token) (!(token)->buf && ((token)->var->Type() == VAR_NORMAL || (token)->var->Type() == VAR_CLIPBOARD)) 
// i.e. it's an evironment variable or the clipboard, not a built-in variable or double-deref.
