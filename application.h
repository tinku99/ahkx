...
// todo: linux version of msgmonitor
...
/* todo: linux versions of the callbacks below: msgboxtimeout, autoexecsectiontimeout...
CALLBACK 
CALLBACK 
CALLBACK 
CALLBACK 
CALLBACK 
 */
VOID MsgBoxTimeout(HWND hWnd, UINT uMsg, UINT idEvent, DWORD dwTime);
VOID AutoExecSectionTimeout(HWND hWnd, UINT uMsg, UINT idEvent, DWORD dwTime);
VOID UninterruptibleTimeout(HWND hWnd, UINT uMsg, UINT idEvent, DWORD dwTime);
VOID InputTimeout(HWND hWnd, UINT uMsg, UINT idEvent, DWORD dwTime);
VOID RefreshInterruptibility(HWND hWnd, UINT uMsg, UINT idEvent, DWORD dwTime);
