...
void * GetKeyboardLayout(int x){   // todo: implement this functions: translate x11 keysym to VK_...
  return NULL; 
}
...
// todo: linux callback procedure LRESULT PlaybackProc(int aCode, WPARAM wParam, LPARAM lParam);
LRESULT PlaybackProc(int aCode, WPARAM wParam, LPARAM lParam);
...
// todo: linux 	procedureCALLBACK RecordProc(int aCode, WPARAM wParam, LPARAM lParam);
