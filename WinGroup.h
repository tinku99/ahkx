...
// todo: callbacks in linux for enumparentfindanyexcept and enumparentactuponall
BOOL EnumParentFindAnyExcept(HWND aWnd, LPARAM lParam);
BOOL EnumParentActUponAll(HWND aWnd, LPARAM lParam);
